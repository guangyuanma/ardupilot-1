...
void  ModeDrawStar::generate_path()
{
	...
	path[1] = path[0] + Vector3f(1.0,0,0)*radius_cm;

	path[2] = path[0] + Vector3f(-cosf(radians(36.0f)),-sinf(radians(36)),0)*radius_cm;

	path[3] = path[0] + Vector3f(sinf(radians(18.0f)),cosf(radians(18)),0)*radius_cm;
	path[4] = path[0] + Vector3f(sinf(radians(18.0f)),-cosf(radians(18)),0)*radius_cm;

	path[5] = path[0] + Vector3f(-cosf(radians(36.0f)),sinf(radians(36)),0)*radius_cm;
